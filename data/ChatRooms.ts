export default [{
    ...
    users: [{
      ...
      id: 'u4',
      name: 'Alex',
      imageUri: 'https://picsum.photos/id/4/200/300',
    }],
    lastMessage: {
      id: 'm3',
      content: 'Hi, Vadim.',
    ...
    users: [{
      ...
      id: 'u5',
      name: 'Vlad',
      imageUri: 'https://picsum.photos/id/6/200/300',
    }],
    lastMessage: {
      id: 'm4',
    ...
    users: [{
      ...
      id: 'u6',
      name: 'Elon Musk',
      imageUri: 'https://picsum.photos/id/9/200/300',
    }],
    lastMessage: {
      id: 'm5',
    ...
    users: [{
      ...
      id: 'u7',
      name: 'Adrian',
      imageUri: 'https://picsum.photos/id/8/200/300',
    }],
    lastMessage: {
      id: 'm6',
    ...
    users: [{
      ...
      id: 'u8',
      name: 'Borja',
      imageUri: 'https://picsum.photos/id/10/200/300',
    }],
    lastMessage: {
      id: 'm7',
      content: 'How are you doing?',
    ...
    users: [{
      ...
      id: 'u9',
      name: 'Mom',
      imageUri: 'https://picsum.photos/id/15/200/300',
    }],
    lastMessage: {
      id: 'm8',
    ...
    users: [{
      ...
      id: 'u10',
      name: 'Angelina Jolie',
      imageUri: 'https://picsum.photos/id/18/200/300',
    }],
    lastMessage: {
      id: 'm9',
